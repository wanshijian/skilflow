...
// Lucide-convention SVG: 24x24, 2px stroke, round caps, round joins, currentColor
...
const icons = {
  ...
  flask:    '<path d="M10 2v7.31a2 2 0 0 1-.242.97L5.035 18.2A2 2 0 0 0 6.66 21h10.68a2 2 0 0 0 1.625-2.8l-4.723-7.92A2 2 0 0 1 14 9.31V2"/><path d="M8.5 2h7"/>',
...
// 渲染为 base64 data-uri + inline background-image（兼容 Taro View）
export default function Icon({ name, size = 24, className = '' }: IconProps) {
  const svg = wrap((icons as any)[name] || '', size)
